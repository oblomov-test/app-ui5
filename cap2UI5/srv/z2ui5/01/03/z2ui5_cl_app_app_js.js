...
/**
 * z2ui5_cl_app_app_js — JS port of abap2UI5 z2ui5_cl_app_app_js.
 *
 * abap holds the source as an ABAP string template; in CAP the file lives on
 * disk under app/app_v2_new/webapp/cc/Server.js and is normally served by CAP's
 ...
 */
class z2ui5_cl_app_app_js {

  static MIME = "application/javascript";
  static FILE_PATH = path.join(__dirname, "../../../../app/app_v2_new/webapp/cc/Server.js");

  /** Returns the file content as a string (or null if missing). */
  static get_source() {
    try {
      return fs.readFileSync(z2ui5_cl_app_app_js.FILE_PATH, "utf8");
    } catch {
      return null;
    }
  }
...
module.exports = z2ui5_cl_app_app_js;
