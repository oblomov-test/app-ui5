...
const page = z2ui5_cl_xml_view.factory( ).shell(
         ).page({ title: `Sample: MultiComboBox - Suggestions wrapping`, navbuttonpress: this.client._event_nav_app_leave( ), shownavbutton: this.client.check_app_prev_stack( ) });
    ...
    layout.multi_combobox({ id: `wrappingMultiComboBox`, width: `350px` }).item({ key: `1`, text: `Wireless DSL/ Repeater and Print Server Lorem ipsum dolar st amet, consetetur sadipscing elitr, ` &&
