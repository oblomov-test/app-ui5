 ...
 * ====================
 * CLASS z2ui5_cl_demo_app_131 DEFINITION PUBLIC.
 * 
 *   PUBLIC SECTION.
...
class z2ui5_cl_demo_app_131 extends z2ui5_if_app {
  client = null;
  async main(client) {
    this.client = client;
    if (client.check_on_init()) {
      const v = z2ui5_cl_xml_view.factory()
        .Page({ title: "z2ui5_cl_demo_app_131 (TODO: port from abap)" })
...
module.exports = z2ui5_cl_demo_app_131;
