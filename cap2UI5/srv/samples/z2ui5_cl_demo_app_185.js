 ...
 * ====================
 * CLASS z2ui5_cl_demo_app_185 DEFINITION PUBLIC.
 * 
 *   PUBLIC SECTION.
...
class z2ui5_cl_demo_app_185 extends z2ui5_if_app {
  client = null;
  async main(client) {
    this.client = client;
    if (client.check_on_init()) {
      const v = z2ui5_cl_xml_view.factory()
        .Page({ title: "z2ui5_cl_demo_app_185 (TODO: port from abap)" })
...
module.exports = z2ui5_cl_demo_app_185;
