 ...
 * disk under app/app_v2_new/webapp/view/App.view.xml and is normally served by CAP's
...
class z2ui5_cl_app_view1_xml {
  ...
  static FILE_PATH = path.join(__dirname, "../../../../app/app_v2_new/webapp/view/App.view.xml");

  /** Returns the file content as a string (or null if missing). */
  static get_source() {
    try {
      return fs.readFileSync(z2ui5_cl_app_view1_xml.FILE_PATH, "utf8");
    } catch {
      return null;
    }
  }
