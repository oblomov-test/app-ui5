...
/**
 * z2ui5_cl_app_server_js — JS port of abap2UI5 z2ui5_cl_app_server_js.
 *
...
class z2ui5_cl_app_server_js {
  ...
  static get_source() {
    try {
      return fs.readFileSync(z2ui5_cl_app_server_js.FILE_PATH, "utf8");
    } catch {
      return null;
    }
  }
...
module.exports = z2ui5_cl_app_server_js;
