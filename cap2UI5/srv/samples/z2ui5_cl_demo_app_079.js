...
class z2ui5_cl_demo_app_079 extends z2ui5_if_app {
...
if (this.client.check_on_init( )) {
      ...
      const view = z2ui5_cl_xml_view.factory( ).shell( ).page({ title: `PDF Output`, navbuttonpress: this.client._event_nav_app_leave( ), shownavbutton: this.client.check_app_prev_stack( ) })._generic({ ns: `html`, name: `iframe`, t_prop: [{ n: `src`, v: get_example_pdf( ) }, { n: `height`, v: `90%` }, { n: `width`, v: `90%` }] });
...
module.exports = z2ui5_cl_demo_app_079;
